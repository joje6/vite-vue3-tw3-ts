<template>
  <div
    class="w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06] bg-white/95 supports-backdrop-blur:bg-white/60 dark:bg-transparent"
  >
    <div class="max-w-8xl mx-auto">
      <div class="py-4 border-b border-slate-900/10 lg:px-8 lg:border-0 dark:border-slate-300/10 mx-4 lg:mx-0">
        <div class="relative flex items-center">
          ...
          <a
            class="ml-3 text-xs leading-5 font-medium text-sky-600 dark:text-sky-400 bg-sky-400/10 rounded-full py-1 px-3 hidden xl:flex items-center hover:bg-sky-400/20"
            href="/blog/tailwindcss-v3"
          >
            <strong class="font-semibold">Tailwind CSS v3.0</strong>
            <svg width="2" height="2" fill="currentColor" aria-hidden="true" class="ml-2 text-sky-600 dark:text-sky-400/70">
              <circle cx="1" cy="1" r="1"></circle>
            </svg>
            <span class="ml-2">Just-in-Time all the time, colored shadows, scroll snap and more</span>
      ...
      <div class="flex items-center p-4 border-b border-slate-900/10 lg:hidden dark:border-slate-50/[0.06]">
        ...
        <ol class="ml-4 flex text-sm leading-6 whitespace-nowrap min-w-0">
          ...
          <li class="font-semibold text-slate-900 truncate dark:text-slate-200">Dark Mode</li>
        </ol>
      </div>
    </div>
  </div>
  <HelloWorld class="mb-60" msg="Hello Vue 3 + TypeScript + Vite + Tailwindcss 3" />
</template>
